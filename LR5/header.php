...
<div class = "container">
    ...
    <div class = "container">
        <div class="row align-items-center">
            <div class="col-md-3 text-black-50"><a class = "nav-link" href="#"> <H2><i class="bi bi-pc-display-horizontal text-primary" ></i> минжкх</H2> </a></div>
            <div class="col-md-8">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mb-2 mb-lg-0">
                                ...
                                <li class ="nav-item">
                                    <a class = "nav-link text-danger" href ="text.php">ТЕКСТОВАЯ СТРАНИЦА</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="col-md-1">
                <div class="col-md-3">
                    <a href="#">  <i class="bi bi-search text-white bg-primary"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page-h1">
        <div class ="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class = "nav-link" href="#"></a></li>
